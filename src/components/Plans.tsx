...
const Plans = () => {
  ...
  return (
    <div className=" py-24">
      ...
      <div className="relative text-center w-fit mx-auto mt-8 flex justify-center items-center">
        <button
          className={`relative z-10 p-4 rounded-lg transition-all duration-300 ${
            activeButton === "annual"
              ? "text-white bg-gradient-to-r from-[#79C6CE] to-[#B4E0C9]"
              : "text-gray-600"
          }`}
      ...
      <div className="container px-4 grid gap-6 grid-cols-3 mx-auto mt-28">
        ...
        <div
          ...
          className="border-[#b3e0c5] translate-y-[-48px]  h-[524px] bg-white border-2   p-4 rounded-2xl   "
        >
          <div>
            {" "}
            <h3 className=" font-medium text-right  text-[#4D6782]">
          ...
          <div>
            {" "}
            <div className=" flex items-end gap-5 flex-col mt-10">
          ...
          <div className=" w-[95%] mx-auto  mt-8  text-center">
            {" "}
            <button className="text-white bg-gradient-to-r from-[#79C6CE] to-[#B4E0C9]  w-full rounded-lg  text-[20px] font-medium h-[48px]   border-[#b3e0c5] border-2">
              اكتشف الخطه
            </button>{" "}
          </div>
        </div>
        <div className="border-[#79C6CE] h-[524px] bg-[#79C6CE13] border-2   p-4 rounded-2xl">
          <div>
            {" "}
            <h3 className=" font-medium text-right  text-[#4D6782]">
